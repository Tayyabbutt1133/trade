...
export function EmailForm({ emailId, initialData = null }) {
    ...
    if (initialData) {
      return {
        ...
        description: initialData.description
          ? restoreAngleBrackets(initialData.description)
          : "",
  ...
  const [footerPositionOptions, setFooterPositionOptions] =
    useState(positionOptions);
  ...
  useEffect(() => {
    if (formData["headlogopos"]) {
      ...
      let newOptions = positionOptions.filter(
        (option) => option.value !== headerPosition
      );
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // settiing loader state to true as soon as it clicks !
    ...
    const processedDescription = replaceAngleBrackets(
    ...
    try {
      ...
      // async handling to handle route operation through web API
      setTimeout(() => {
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="grid gap-6">
        <div className="grid gap-4">
          ...
          {/* Header Logo Field */}
          <div className="grid gap-2">
            <Label htmlFor="headlogo">Header Logo</Label>
          ...
          <div className="grid gap-2">
            <Label htmlFor="headlogopos">Header Logo Position</Label>
            <Select
              onValueChange={(value) =>
                handleSelectChange("headlogopos", value)
              }
          ...
          {/* Header Text Field */}
          <div className="grid gap-2">
            <Label htmlFor="headtext">Header Text</Label>
            <Input
              id="headtext"
              type="text"
              required={false}
          ...
          {/* Footer Logo Field */}
          <div className="grid gap-2">
            <Label htmlFor="footlogo">Footer Logo</Label>
          ...
          <div className="grid gap-2">
            <Label htmlFor="footlogopos">Footer Logo Position</Label>
            <Select
              onValueChange={(value) =>
                handleSelectChange("footlogopos", value)
              }
          ...
          {/* Footer Text Field */}
          <div className="grid gap-2">
            <Label htmlFor="foottext">Footer Text</Label>
            <Input
              id="foottext"
              type="text"
              required={false}
