        ...
        <RxHamburgerMenu size={25} className='lg:hidden block text-white' onClick={handleToggle} />
          ...
          <div className='flex items-center gap-0 md:gap-2'>
            ...
            <div className='flex gap-1'>
              <button
                className={`text-sm px-5 text-white ${fonts.montserrat} py-2 rounded-md transition-all ${
                  !isSignIn
                    ? "bg-[#060E1BCC]  hover:scale-105 hover:bg-[#081023CC]"
                    : "bg-transparent  hover:bg-[#081023CC]  hover:scale-105 hover:text-white"
                }`}
              ...
              <button
                className={`text-sm text-white ${fonts.montserrat} px-5 py-2 rounded-md transition-all ${
                  isSignIn
                    ? "bg-[#060E1BCC]  hover:scale-105 hover:bg-[#081023CC]"
                    : "bg-transparent hover:bg-[#081023CC] hover:scale-105 hover:text-white"
                }`}
      ...
      <div className=' w-full mx-2 my-2'>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className={`flex ${fonts.montserrat} items-center gap-1 text-white px-3 py-2 focus:outline-none text-sm`}>
