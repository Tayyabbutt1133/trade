        ...
        <div className="mt-6" ref={dropdownref}>
          ...
          >
            <div className="flex gap-2">
              ...
              <span className={`${fonts.montserrat}`}>Applications</span>
            </div>
            {isOpen ? (
          ...
          {/* Dropdown menu */}
          {isOpen && (
            <div className="mt-2 rounded-md shadow-lg w-96 bg-white ring-1 ring-black ring-opacity-5 z-10 relative">
              <div className="p-2 max-h-96 overflow-y-auto">
                {topCategories.map(([topCategory, secondLevelArray]) => (
                  <div key={topCategory} className="mb-2">
                    ...
                    >
                      <span className="capitalize font-bold">{topCategory}</span>
